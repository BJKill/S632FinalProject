...
mod1.1 <- glm(formula = cbind(COVID_DEATHS.x, pop2021.x - COVID_DEATHS.x) ~ olderprop + 
    `2013 code` + prop_cases + TrmpProp + ClintProp + ClintVote.x + 
    `Older (65 plus).x` + RARELY + COVID_COUNT.x + olderprop:`2013 code` + olderprop:TrmpProp +
...
# remove COVID_COUNT
mod1.2 <- glm(formula = cbind(COVID_DEATHS.x, pop2021 - COVID_DEATHS.x) ~ olderprop + 
...
mod1.3 <- glm(formula = cbind(COVID_DEATHS.x, pop2021 - COVID_DEATHS.x) ~ olderprop + 
    `2013 code` + prop_cases + TrmpProp + ClintProp + ClintVote + 
...
mod1.4 <- glm(formula = cbind(COVID_DEATHS.x, pop2021 - COVID_DEATHS.x) ~ olderprop + 
    `2013 code` + prop_cases + TrmpProp + ClintProp + ClintVote + 
...
mod2 <- glmer(formula = cbind(COVID_DEATHS.x, pop2021 - COVID_DEATHS.x) ~ offset(log(pop2021)) + olderprop + 
