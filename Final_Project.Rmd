...
big_data3$cntyPol[which(big_data3$TrmpProp > 0.65)] <- "StrongRep"
big_data3$cntyPol[which((big_data3$TrmpProp < 0.65)&(big_data3$TrmpProp > 0.5))] <- "LeanRep"
big_data3$cntyPol[which(big_data3$ClintProp > 0.65)] <- "StrongDem"
big_data3$cntyPol[which((big_data3$ClintProp < 0.65)&(big_data3$ClintProp > 0.5))] <- "LeanDem"
